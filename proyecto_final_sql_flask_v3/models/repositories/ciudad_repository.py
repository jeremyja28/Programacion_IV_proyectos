"""
Repositorio de Ciudad - Responsabilidad: Acceso a datos de ciudades
"""
...
class CiudadRepository(BaseRepository):
    """
    Repositorio para operaciones de datos de ciudades
    
    Responsabilidades:
    - Operaciones CRUD específicas para ciudades
