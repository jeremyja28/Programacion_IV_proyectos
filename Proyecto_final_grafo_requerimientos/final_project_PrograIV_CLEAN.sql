...
-- VERSIÓN SEGURA - Limpia y recrea datos
-- =============================================
...
-- Limpiar tablas existentes en orden correcto (usar DELETE en lugar de TRUNCATE)
DELETE FROM rutas WHERE 1=1;
DELETE FROM ciudades WHERE 1=1;
DELETE FROM provincias WHERE 1=1;
