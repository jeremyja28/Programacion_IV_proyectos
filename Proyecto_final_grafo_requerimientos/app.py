...
def create_app():
        ...
        try:
            ...
            try:
                ...
                if provincia_count == 0 or ciudad_count == 0 or admin_count == 0:
                    ...
                    print("[INFO] Ejecuta 'python reset_database.py' para inicializar los datos")
                else:
                    print("[OK] Base de datos inicializada correctamente")
                    
            except Exception as e:
                print(f"[WARNING] Error accediendo a las tablas: {str(e)}")
                print("[INFO] Ejecuta 'python reset_database.py' para resetear la base de datos")
                
        except Exception as e:
            print(f"[ERROR] Error creando tablas: {str(e)}")
            print("[INFO] Verifica la configuración de la base de datos")
            print("[INFO] Asegúrate de que Laragon esté ejecutándose con MySQL en puerto 3307")
    ...
    def handle_internal_error(error):
        ...
        # Para otros errores 500, mostrar página de error genérica
        return render_template('error.html', 
